...
public class ShowMsg extends Activity {
    ...
    public void showExceptionOnMainThread(Exception e, String method, Context context) {
        String msg = "";
        ...
        showMsgOnMainThread(msg, context);
    }
    ...
    public void showResultOnMainThread(int code, String errMsg, Context context) {
        String msg = "";
    ...
    public void showMsgOnMainThread(String msg, Context context) {
        mDispMessage = msg;
        mContext = context;

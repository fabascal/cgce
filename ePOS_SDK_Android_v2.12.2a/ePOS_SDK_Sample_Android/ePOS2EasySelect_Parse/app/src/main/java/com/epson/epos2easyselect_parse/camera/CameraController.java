package com.epson.epos2easyselect_parse.camera;
...
public class CameraController
    ...
    private boolean mWaitScanPreview = true;
...
//		stopPreview();
     ...
     * @param wait
     */
    public void waitScanPreview(
            boolean wait) {
        mWaitScanPreview = wait;
    }

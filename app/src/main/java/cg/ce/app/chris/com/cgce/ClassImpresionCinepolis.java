...
public class ClassImpresionCinepolis extends AsyncTask<JSONObject,String,Boolean>  implements ReceiveListener {
    Activity activity;
    Context context;
    ...
    public boolean createReceiptData() {
        String method = "";
        Bitmap logoData = BitmapFactory.decodeResource(activity.getResources(), R.drawable.repsolcinepolis);
        ...
        try {
            ...
            textData.append("--------------------------------------------"+"\n");
            textData.append("" + json.getString("descripcion")  + "\n");
            textData.append("--------------------------------------------"+"\n");
            textData.append("Folio Cinepolis     : " + json.getString("folio") + "\n");
            textData.append("Vigencia hasta      : " + json.getString("fecha") + "\n");
            textData.append("Precio sencillo     : " + json.getString("precio")+"\n");
            textData.append("Numero de entradas  : " + json.getString("numEntradas")+"\n");
            textData.append("--------------------------------------------"+"\n");
            mPrinter.addText(textData.toString());

            method = "addBarcode";
            mPrinter.addTextAlign(Printer.ALIGN_CENTER);
            mPrinter.addBarcode(String.valueOf(json.getString("folio")),

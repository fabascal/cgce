...
public class Cinepolis extends AsyncTask<Void, Void, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        try {
            ...
            if (res.has("promo")){
                if (res.getString("promo").equals("1")){
                    //Web service promocion
                    Log.w("Res entro", String.valueOf(res));
                    CinepolisPromo cinepolis = new CinepolisPromo();
                    cinepolis.execute();
                }
                else{
    ...
    public class CinepolisPromo extends AsyncTask<Void, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            pdialog.setCancelable(false);
            pdialog.setTitle("Combu-Express");
            pdialog.setMessage("Cinepolis promo...");pdialog.show();
        }
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                url = new URL("http://factura.combuexpress.mx/cinece/wscombugo2x1.php");
            } catch (MalformedURLException e) {
                e.printStackTrace();
            }
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            jsonrespuesta=tojson.strtojson(result,"|");
            try {
                res.put("promo_data",new JSONObject(String.valueOf(jsonrespuesta.getString("0"))));
                //res=new JSONObject(String.valueOf(jsonrespuesta.getString("0")));
                //if (res.has("promo")){
                //    if (res.getString("promo").equals("1")){
                        //Web service promocion
